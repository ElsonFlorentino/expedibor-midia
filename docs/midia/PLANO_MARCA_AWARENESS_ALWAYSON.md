...
## 2. Plataforma e objetivo

### Meta Ads (canal primário)
- **Objetivo:** Reconhecimento.
- **Otimização:** **aumento estimado da lembrança do anúncio (ad recall lift)** — entrega para quem tem mais chance de **lembrar** da marca. (Use "Alcance" só se quiser puro alcance único; para "reconhecimento", recall é mais on-the-nose.)
- **Posicionamentos:** Feed, Reels e Stories.
- **Criativo:** vídeo curto institucional/produto + estático, sempre com logo e identidade da marca.
...
- Produto + aplicação (qual peça serve em qual veículo)
- Qualidade e processo (fábrica, ISO 9001)
- Dica técnica para o aplicador/mecânico
- Bastidores e pessoas
- Prova (onde a marca está, clientes)

Rodar 3 a 5 criativos e deixar o algoritmo priorizar os de melhor recall/retenção.

## 5. Métricas (reconhecimento, não lead)
- **Alcance** e **impressões**
- **Frequência** (mirar 2 a 4 no período)
- **CPM** (eficiência)
- **Aumento estimado da lembrança do anúncio (ad recall lift)** quando disponível
- **Views / VTR** e **thumb-stop ratio** (vídeo)
- **Crescimento de seguidores e de público alcançado**
- NÃO acompanhar por leads/CPL/CPA (não é o objetivo).

## 6. Ponte com a feira
O público alcançado e engajado nesta fase vira **público quente/retargeting** na campanha de awareness da MinasParts (set/out). Ou seja: o investimento de marca agora **barateia e potencializa** a campanha da feira depois.
